								...
								<div class="panel uploads">
									<div class="panel-body panel-portfolio no-padding">
										...
										<div class="partition partition-white padding-15">
											...
											Welcome To <b> Nana_perpustakaan</b> Perpustakaan
												</div>
						...
						<!---verli rata END-->
								...
								<div class="panel panel-default panel-white core-box">
									...
									<div class="panel-body no-padding">
										...
										<div class="padding-20 core-content">
											<h3 class="title block no-margin">Pengunjung </h3>
											Lihat pengunjung
										</div>
									</div>
									<div class="panel-footer clearfix no-padding">
										<div class=""></div>
										<a href="ver_spoilerbukuUSER.php" class="col-xs-4 padding-10 text-center text-white tooltips partition-blue" data-toggle="tooltip" data-placement="top" title="Lihat Via Spoiler"><i class="fa fa-plus"></i></a>
									</div>
								</div>
							</div>
								...
								<div class="panel panel-default panel-white core-box">
									...
									<div class="panel-body no-padding">
										...
										<div class="padding-20 core-content">
											<h3 class="title block no-margin">Lihat Daftar Buku</h3>
											Lihat Buku populer
											</div>
									</div>
									<div class="panel-footer clearfix no-padding">
												<a href="ver_lihatUSER.php" class="col-xs-4 padding-10 text-center text-white tooltips partition-red" data-toggle="tooltip" data-placement="top" title="Lihat Via List"><i class="fa fa-chevron-right"></i></a>
									</div>
								</div>
							</div>
							</div>
