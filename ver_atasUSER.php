...
<head>
		<title>Perpustakaan Unila</title>
		<!-- start: META -->
		<meta charset="utf-8" />
				...
				<!--STOP:  VERLY MINI AVATAR-->
								<ul class="dropdown-menu dropdown-dark">
									<li>
										...
										<li>
										<a href="ver_bukupinjamUSER.php?id_user=<?php echo $_SESSION['id_login']; ?>">
											Buku Yang Aku Pinjam
										</a>
									</li>
									<li>
										<a href="ver_lockscreenUSER.php">
											Lock Screen
										</a>
									</li>
									<li>
			...
			<nav id="pageslide-left" class="pageslide inner">
				<div class="navbar-content">
					...
					<div class="main-navigation left-wrapper transition-left">
						...
						<!--START:  NANA SESSION USERNAME AND AVATAR-->
...
if($_SESSION['level']!="user"){
    die("Anda bukan admin");//jika bukan admin jangan lanjut
						...
						<!-- STOP: NANA SESSION USERNAME AND AVATAR-->
						<!-- start: MAIN NAVIGATION MENU -->
						<ul class="main-navigation-menu">
							<li class="active open">
								<a href="ver_indexUSER.php"><i class="fa fa-home"></i> <span class="title"> Dashboard </span><span class="label label-default pull-right ">LABEL</span> </a>
							</li>		
						</ul>
