...
<head>
		<title>Login Perpustakaan Unila</title>
		<!-- start: META -->
		<meta charset="utf-8" />
	...
	<body class="login">
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				<!-- start: LOGIN BOX -->
				<div class="box-login">
					<h3>Login Perpustakaan Unila</h3>
					<p>
					...
					<!-- start: COPYRIGHT -->
					<div class="copyright">
						2018-2019 &copy; Perpustakaan Unila by DianatiPutri.
					</div>
					<!-- end: COPYRIGHT -->
				</div>
				<!-- end: LOGIN BOX -->
				...
				<div class="box-register">
					...
					<form class="form-register">
						...
						<br>
								...
								<div class="form-actions">
								Udah punya akun anggota Perpustakaan?
